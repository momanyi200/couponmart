...
<div class="max-w-6xl mx-auto mb-8 pt-16">
    <div class="w-full">
        ...
        <div class="text-center">
            <h3 class="logsubs text-2xl font-semibold">Add Coupon image</h3>
            <span class="text-gray-600">Step 3: Use the form below to add image to the site</span>
        </div>
    </div>
</div>
...
<div class="max-w-6xl mx-auto flex justify-center items-center min-h-[45vh]">
    <div class="w-full max-w-2xl">
        <form action="{{ route('admin.coupons.saveimage',$id) }}" method="POST" enctype="multipart/form-data">
            @csrf
